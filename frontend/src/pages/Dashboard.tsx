              ...
              {listings.slice(0, 4).map((listing) => (
                <Grid size={{ xs: 12, sm: 6, md: 3 }} key={listing.id}>
                  ...
                  >
                    ...
                    <CardContent sx={{ p: 2 }}>
                      <Typography variant="subtitle2" fontWeight={600} noWrap sx={{ mb: 1 }} color="text.primary">
                        {listing.title}
                      </Typography>
            ...
            <Box>
              <Grid container alignItems="center" justifyContent="space-between">
                <Grid size={{ xs: 12, md: 8 }}>
                  <Typography variant="h3" component="h1" fontWeight={700} gutterBottom sx={{ color: 'primary.contrastText' }}>
                    Welcome to Parking in a Pinch, {user?.first_name}! 🎉
                  </Typography>
                  <Typography variant="h6" sx={{ opacity: 0.9, fontWeight: 300, color: 'primary.contrastText' }}>
