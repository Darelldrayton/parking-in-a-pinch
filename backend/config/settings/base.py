...
# Email Configuration
# Use SMTP backend for production emails, console for development
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='Parking in a Pinch <noreply@parkinginapinch.com>')
SERVER_EMAIL = DEFAULT_FROM_EMAIL

# Email template settings
EMAIL_SUBJECT_PREFIX = '[Parking in a Pinch] '
EMAIL_TIMEOUT = 30
